...
export default class FacturesPayees extends Component {
    ...
    componentDidMount(){
        ...
        fetch(GLOBAL.BASE_URL_REG+"WSFacture/listeFactures?ent_num=500002&etat=1&start="+this.state.start)
    ...
    prev = () => {
        ...
        fetch(GLOBAL.BASE_URL_REG+"WSFacture/listeFactures?ent_num=500002&etat=1&start="+this.state.start+"&search="+this.state.search)
            .then(response => response.json())
            .then(responseJson => {
              this.setState({
                tableData: responseJson,
      ...
      _search = search => {
        ...
        const GLOBAL = require('../../Global');
          ...
          fetch(GLOBAL.BASE_URL_REG+"WSFacture/listeFactures?ent_num=500002&etat=1&start="+this.state.start+"&search="+search)
              .then(response => response.json())
              .then(responseJson => {
                this.setState({
                  tableData: responseJson
